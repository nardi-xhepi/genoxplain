...
function Input({ className, type, variant = "default", ...props }: React.ComponentProps<"input"> & { variant?: "default" | "neon" }) {
  return (
    <input
      type={type}
      data-slot="input"
      className={cn(
        ...
        variant === "default" ? 
          ...
          "focus:neon-border focus:neon-glow-primary focus:outline-none focus:border-primary",
